...
def home():
    ...
    try:
        ...
        return render_template("index.html" , page_name = "WHAT2WATCH" , movieList  = jsonData , query =query)
...
def search_results():
    ...
    try:
        ...
        data = response.read()
        jsonData = json.loads(data)["Search"]
        return render_template("index.html" , page_name = "SEARCH RESULTS" , movieList = jsonData , query = movieName)
    except Exception as e:
        print(e)
